...
void EggQuizPopup::setCommon(char category, int level)
{
    ...
    auto bg = Sprite::create("EggQuiz/Popup/popup_window_bg.png");
    ...
    string panelFilename = category=='L' ? "daily_window_title_panel_English.png" : "daily_window_title_panel_math.png";
...
Node* createEgg(char category, int level, Size winSize)
{
    ...
    auto egg = Sprite::create("EggQuiz/Popup/"+eggName+".png");
...
Node* createBird(char category, int level, Size winSize)
{
    ...
    auto bird = Sprite::create("EggQuiz/Popup/"+name+".png");
...
Node* createGlow()
{
    ...
    {
        auto sp = Sprite::create("EggQuiz/Popup/popup_window_glow_toleft.png");
        node->addChild(sp);
    ...
    {
        auto sp = Sprite::create("EggQuiz/Popup/popup_window_glow_toright.png");
        node->addChild(sp);
...
void EggQuizPopup::setConfirmQuit(char category, int level)
{
    ...
    {
        auto btn = createButton("EggQuiz/Popup/popup_button_test_exit", "Stop the test");
    ...
    {
        auto btn = createButton("EggQuiz/Popup/popup_button_test_backtotest", "Go back to test");
...
void EggQuizPopup::setPreCompleted(char category, int level)
{
    ...
    {
        auto sp = Sprite::create("EggQuiz/Popup/popup_window_ribbon_back.png");
    ...
    {
        auto sp = Sprite::create("EggQuiz/Popup/popup_window_ribbon_front.png");
        sp->setPosition(winSize.width/2, winSize.height-750);
        this->addChild(sp);
    ...
    {
        auto btn = createButton("EggQuiz/Popup/popup_window_check", "");
...
void EggQuizPopup::setPostCompleted(char category, int level)
{
    ...
    {
        for (int i=0; i<60; i++) {
            auto file = StringUtils::format("EggQuiz/Popup/popup_effect_confetti_%d.png", random(1, 8));
...
void EggQuizPopup::setPreFailed(char category, int level)
{
    ...
    {
        auto btn = createButton("EggQuiz/Popup/pretest_button_back", "");
