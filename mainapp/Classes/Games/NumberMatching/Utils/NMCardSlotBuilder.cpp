//
//  NMCardSlotBuilder.cpp on Aug 8, 2016
//  TodoSchool
//
...
vector<Point> NMCardSlotBuilder::pointsInBoundary(size_t cardCount,
                                                Rect boardRect,
                                                Size cardSize)
{
...
vector<Point> NMCardSlotBuilder::candidatePointsInBoundary(size_t cardCount,
                                                         Rect boardRect,
                                                         Size cardSize)
{
