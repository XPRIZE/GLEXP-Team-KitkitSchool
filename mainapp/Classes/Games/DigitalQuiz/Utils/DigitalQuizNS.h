//
//  DigitalQuizNS.h -- Namespace management for DigitalQuiz
...
#define BEGIN_NS_DIGITALQUIZ \
namespace todoschool { \
namespace digitalquiz {

#define END_NS_DIGITALQUIZ \
} \
}
...
// NB(xenosoz, 2016): It modifies CREATE_FUNC to accept __TYPE__::create(x, y, z ...).
...
using cocos2d::ui::RichText;
using cocos2d::ui::RichElement;
using cocos2d::ui::RichElementText;
using cocos2d::ui::RichElementImage;
