//
//  DigitalQuizScene.cpp -- Pre/post testing
...
DigitalQuizScene::DigitalQuizScene()
: TheGameNode(nullptr)
...
void DigitalQuizScene::clearInternals() {
...
void DigitalQuizScene::refreshChildNodes() {
    removeAllChildren();
...
void DigitalQuizScene::prepareFirstProblem() {
    ProblemID = TheWorksheet().beginProblemID();
}

void DigitalQuizScene::prepareNthProblem(int N) {
    ProblemID = N;
}

void DigitalQuizScene::prepareNextProblem() {
    ProblemID += 1;
}

void DigitalQuizScene::beginTheProblem() {
...
void DigitalQuizScene::commitTheProgress() {
    TheSavedState().updateProblemID(ProblemID);
    TheSavedState().updateTestClock(TestClock());
}

void DigitalQuizScene::writeTheAnswerToLog(const string& Answer) {
    Json::Value JV;
...
void DigitalQuizScene::handleAnyAnswer(const string& Answer) {
    commitTheProgress();
...
void DigitalQuizScene::handleSuccess() {
...
void DigitalQuizScene::handleFail() {
    auto Guard = NodeScopeGuard(this);
...
Stage* DigitalQuizScene::createStageNode() {
    Stage* It = nullptr;
...
void DigitalQuizScene::update(float DeltaSeconds) {
...
void DigitalQuizScene::onEnterTransitionDidFinish() {
...
void DigitalQuizScene::onExitTransitionDidStart() {
    Super::onExitTransitionDidStart();
}

void DigitalQuizScene::onEnter() {
    Super::onEnter();
    scheduleUpdate();
}

void DigitalQuizScene::onExit() {
    Super::onExit();
    unscheduleUpdate();
}
