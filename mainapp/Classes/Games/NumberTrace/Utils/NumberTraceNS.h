//
//  NumberTraceNS.h -- Namespace management for NumberTrace
...
#define BEGIN_NS_NUMBERTRACE \
namespace todoschool { \
namespace numbertrace {

#define END_NS_NUMBERTRACE \
} \
}
...
// NB(xenosoz, 2016): Modified CREATE_FUNC to accept __TYPE__::create(x, y, z ...).
