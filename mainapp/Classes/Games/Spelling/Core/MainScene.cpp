//
//  MainScene.cpp -- Spell-filling game with balls
...
void MainScene::openingGameBoard() {
...
void MainScene::openingWordSound() {
...
void MainScene::openingEjectBalls() {
...
void MainScene::openingPlatform() {
    auto Next = [this] {};
...
void MainScene::closingWordSound() {
...
void MainScene::closingGameBoard() {
