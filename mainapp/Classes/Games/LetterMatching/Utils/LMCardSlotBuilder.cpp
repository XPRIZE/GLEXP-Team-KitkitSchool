//
//  LMCardSlotBuilder.cpp on Aug 8, 2016
//  TodoSchool
//
...
vector<Point> LMCardSlotBuilder::pointsInBoundary(size_t cardCount,
                                                Rect boardRect,
                                                Size cardSize)
{
...
vector<Point> LMCardSlotBuilder::candidatePointsInBoundary(size_t cardCount,
                                                         Rect boardRect,
                                                         Size cardSize)
{
