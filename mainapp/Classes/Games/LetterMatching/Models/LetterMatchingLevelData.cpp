...
#include "LetterMatchingLevelData.hpp"
...
LevelData LevelData::defaultData() {
    ...
    /*
    string p = assetPrefix() + (LanguageManager::getInstance()->isSignLanguageMode() ? "/letterMatching_levels_sl.tsv" : "/letterMatching_levels.tsv");
    string s = FileUtils::getInstance()->getStringFromFile(p);
    */
    
    string dataSheet = "/letterMatching_levels.tsv";
    string dataSheetSL = "/letterMatching_levels_sl.tsv";
