//
//  CardSlotBuilder.cpp on Aug 8, 2016
//  TodoSchool
//
...
vector<Point> CardSlotBuilder::pointsInBoundary(size_t cardCount,
                                                Rect boardRect,
                                                Size cardSize)
{
...
vector<Point> CardSlotBuilder::candidatePointsInBoundary(size_t cardCount,
                                                         Rect boardRect,
                                                         Size cardSize)
{
