...
/**
 * This class binds the services API to your application client.  It contains the IDownloaderClient proxy,
 ...
 * 
 * <p>The IPC is implemented using an Android Messenger and a services Binder.  The connect method
 * should be called whenever the client wants to bind to the services.  It opens up a services connection
 * that ends up calling the onServiceConnected client API that passes the services messenger
 * in.  If the client wants to be notified by the services, it is responsible for then passing its
 * messenger to the services in a separate call.
 *
 ...
 * the specified services and you should then call {@link #CreateStub} to instantiate a member {@link
...
public class DownloaderClientMarshaller {
    ...
    private static class Stub implements IStub {
        ...
        /**
         * Class for interacting with the main interface of the services.
         */
        private ServiceConnection mConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className, IBinder service) {
                // This is called when the connection with the services has been
                // established, giving us the object we can use to
                // interact with the services. We are communicating with the
                // services using a Messenger, so here we get a client-side
     ...
     * @return The {@link IStub} that allows you to connect to the services such that
     ...
     * @return whether the services was started and the reason for starting the services.
     ...
     * @param serviceClass the class of the services to start
     * @return
     * @throws NameNotFoundException
     */
