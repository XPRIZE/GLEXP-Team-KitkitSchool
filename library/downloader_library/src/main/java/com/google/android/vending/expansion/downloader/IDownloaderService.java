 ...
 * DownloaderServiceMarshaller. It contains functions to control the services.
 * When a client binds to the services, it must call the onClientUpdated
 * function.
 * <p>
 * You can acquire a proxy that implements this interface for your services by
...
public interface IDownloaderService {
    ...
    /**
     * Request that the services abort the current download. The services should
     * respond by changing the state to {@link IDownloaderClient.STATE_ABORTED}.
     */
    void requestAbortDownload();

    /**
     * Request that the services pause the current download. The services should
    ...
    /**
     * Request that the services continue a paused download, when in any paused
     ...
     * DownloaderClient to register the client with the services. It will
