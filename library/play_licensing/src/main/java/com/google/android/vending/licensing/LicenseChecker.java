...
public class LicenseChecker implements ServiceConnection {
    ...
    // Timeout value (in milliseconds) for calls to services.
    ...
    /**
     * Checks if the user should have access to the app.  Binds the services if necessary.
     * <p>
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
            ...
            if (mService == null) {
                Log.i(TAG, "Binding to licensing services.");
                try {
                    ...
                    if (bindResult) {
                        ...
                        Log.e(TAG, "Could not bind to services.");
    ...
    private void runChecks() {
        ...
        while ((validator = mPendingChecks.poll()) != null) {
            try {
                Log.i(TAG, "Calling checkLicense on services for " + validator.getPackageName());
    ...
    public synchronized void onServiceDisconnected(ComponentName name) {
        // Called when the connection with the services has been
    ...
    /**
     * Generates policy response for services connection errors, as a result of
    ...
    /** Unbinds services if necessary and removes reference to it. */
    private void cleanupService() {
        if (mService != null) {
            try {
                ...
                // error.
                Log.e(TAG, "Unable to unbind from licensing services (already unbound)");
            }
            mService = null;
        }
    }
